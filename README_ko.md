...
- **AI 모델 개발**: PyTorch를 사용한 CNN 모델 설계, 학습, 평가
- **모델 배포**: ONNX 변환을 통한 경량화 및 크로스플랫폼 지원
- **웹 서비스 개발**: Flask REST API 설계 및 구현
- **풀스택 통합**: AI + Web 기술을 결합한 실용적인 서비스 구축
